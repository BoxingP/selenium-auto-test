...
class CartPageLocators(object):
    ...
    order_summary_msg = (By.ID, 'orderSummary')
    ...
    purchase_order_number = (By.XPATH, '//div[@id="checkoutContent"]//div[@class="card"]/div/div[2]/div/div/div[3]//input')
    continue_button = (By.XPATH, '//div[@id="orderSummary"]//button')
    terms_conditions_accept_button = (By.XPATH, '//div[@id="orderSummary"]//div/input')
    submit_order_button = (By.XPATH, '//div[@id="orderSummary"]//button')
